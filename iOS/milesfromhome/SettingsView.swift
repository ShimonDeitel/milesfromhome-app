...
struct SettingsView: View {
    @AppStorage("milesfromhome.notifyEnabled") private var notifyEnabled: Bool = true
    @AppStorage("milesfromhome.compactMode") private var compactMode: Bool = false
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("About") {
                    Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/milesfromhome-app/privacy.html")!)
                    Text("Version 1.0")
